        ...
        <div className="min-h-screen bg-(--color-surface-muted) font-sans text-(--color-text-primary)">
            ...
            <section className="container mx-auto max-w-6xl px-4 py-16">
                <div className="mb-12 text-center">
                    <h2 className="mb-4 flex items-center justify-center gap-2 text-3xl font-black text-(--color-text-primary) md:text-4xl">
                        <AlertTriangle className="h-8 w-8 text-red-500" /> {t("problemSection.title")}
                    </h2>
                ...
                <div className="container mx-auto max-w-6xl px-4 py-16">
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                        <div className="rounded-3xl border border-emerald-100 dark:border-emerald-900/30 bg-emerald-50 dark:bg-emerald-950/20 p-8">
                            ...
                            <h3 className="mb-3 text-2xl font-black text-(--color-text-primary)">{t("mission.title")}</h3>
                        ...
                        <div className="rounded-3xl bg-slate-900 p-8">
                            ...
                            <h3 className="mb-3 text-2xl font-black text-white">{t("vision.title")}</h3>
            ...
            <section className="container mx-auto max-w-6xl px-4 py-16">
                ...
                <div className="grid grid-cols-2 gap-6 text-center md:grid-cols-4">
                    {[
                        { icon: <Unlock className="h-10 w-10 text-emerald-500" />, title: `${t("coreValues.cards.openSource.title")}`, desc:`${t("coreValues.cards.openSource.description")}` },
                        { icon: <BadgeCheck className="h-10 w-10 text-blue-500" />, title:`${t("coreValues.cards.freeForever.title")}`, desc:`${t("coreValues.cards.freeForever.description")}` },
                        { icon: <Globe className="h-10 w-10 text-purple-500" />, title:`${t("coreValues.cards.inclusive.title")}`, desc:`${t("coreValues.cards.inclusive.description")}` },
                        { icon: <Lock className="h-10 w-10 text-slate-500" />, title: `${t("coreValues.cards.privacy.title")}`, desc:`${t("coreValues.cards.privacy.description")}` },
                    ].map((v, i) => (
                        <div
                            key={i}
